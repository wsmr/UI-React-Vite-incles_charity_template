      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Incles</h1>
              <p className="text-xs text-gray-600">Charity Platform</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <Button className="hidden md:flex bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-2 rounded-full">
              Donate Now
            </Button>
